...
#         # Store poet names and original verses (FIXED: Added these lines)
#         judgment['poet_a_name'] = poet_a_name
#         judgment['poet_b_name'] = poet_b_name
#         judgment['verse_a'] = verse_a  # NEW: Store the actual verse
#         judgment['verse_b'] = verse_b  # NEW: Store the actual verse
